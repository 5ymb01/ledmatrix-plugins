...
# When executed from web interface, __file__ will be the script path
...
def main():
    ...
    if TOKEN_FILE.exists():
        ...
        # When run from web interface, stdin may not be available
        # In that case, proceed with re-authentication
        try:
            ...
            # No stdin available (web interface execution) - proceed with re-authentication
            print("Re-authenticating (no user input available)...")
        else:
